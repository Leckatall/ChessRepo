#ifndef _STATS_PAINTER_H
#define _STATS_PAINTER_H
...
class StatsPainter {
  ...
  private:
    static BarWidths calculate_widths(int totalWidth, const Models::PositionData & data);
...
typedef QWidget typedef46;
class StatsWidget : public typedef46 {
  Q_OBJECT
  public:
    inline explicit StatsWidget(Models::PositionData stats, QWidget * parent = nullptr) : QWidget(parent),
