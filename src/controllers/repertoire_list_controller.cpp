...
RepertoireListController::RepertoireListController(application::Application * app, QWidget * router_widget, RepertoireService & service)
    : Controller(app),
...
void RepertoireListController::onStudyRequest() {

    qDebug() << "Study of " << rep_name << " requested";
}

void RepertoireListController::onEditRequest() {
...
void RepertoireListController::onDeleteRequest() {
